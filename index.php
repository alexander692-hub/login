...
//Login en sistema
//if (!empty($_POST)) {      //aqui valida si se ha presionado el boton ingresar
...
if (isset($_POST["registrar"])) {
    ...
    $usuario = mysqli_real_escape_string($conexion,$_POST['user']);
    $password = mysqli_real_escape_string($conexion,$_POST['pass']);
    $password_encriptada = sha1($password); //ENCRIPTA LA CONTRASEÑAS
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">Sistema De Usuarios </span>
									<span class="white" id="id-text2"> Equipo K</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; Equipo De Servidores K</h4>
							</div>
...
<!-- //aqui comienza el formulario para podernos loguear al sistema -->
...
<!--//aqui termina el formulario para loguearnos al sistema	-->												</label>
<!--//en submit se declara name="ingresar" para arreglar el problema en el ingreso de nuevos registros -->
											...
											<div class="social-login center">
												<a href="https://www.youtube.com/@EbenezerHon" target="_blank" class="btn btn-danger">
													<i class="ace-icon fa fa-youtube" ></i> 
												</a>
												<a href="https://www.facebook.com/ServidoresK" target="_blank" class="btn btn-primary">
											...
											<!--<a href="https://twitter.com/jasingafi" target="_blank" class="btn btn-info">	
												...
												<a href="https://www.instagram.com/ebenezer_hn/" target="_blank" class="btn btn-danger">
